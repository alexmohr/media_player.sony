...
class SonyMediaPlayerEntity(
    CoordinatorEntity[SonyCoordinator],
    MediaPlayerEntity
):
    ...
    def device_class(self) -> MediaPlayerDeviceClass | None:
        ...
        # TODO: Maybe something else in some cases?
    ...
    def update_volume(self):
        ...
        self._attr_is_volume_muted = self.coordinator.data.get("muted", False)
        # TODO: Update muted
